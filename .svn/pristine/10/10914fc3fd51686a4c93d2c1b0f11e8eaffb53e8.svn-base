...
public class Company {
	...
	//private Iterator <BigDecimal> itRi;
	
	private ArrayList<BigDecimal> rms;
	//private Iterator <BigDecimal> itRm;
	
	private static Logger log = Logger.getLogger(Company.class);
	
	
	
//	public Company(int id, String name, int quoteDays) {
//		super();
//		this.id = id;
//		this.name = name;
//		this.quoteDays = quoteDays;
//		this.dates = new ArrayList<Date>(); 
//		this.ri = new ArrayList<BigDecimal>();
//		this.rm = new ArrayList<BigDecimal>();
//	}
